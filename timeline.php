...
<body class="bg-white">
    ...
    <main class="w-[1080px] m-auto py-6">
        <div class="max-w-5xl mx-auto px-0 pl-4">
            ...
            <!-- Timeline Banner -->
            <section class="mb-6">
                <h1 class="text-2xl font-bold mb-3 relative pb-2 text-[#022d5a]">
                    Zaman Çizelgesi
            ...
            <section class="mb-6">
                <h2 class="text-lg font-bold mb-4 text-[#022d5a]">
                    Zaman Çizelgesi Seçin
                </h2>
                <div class="flex flex-wrap gap-2 mb-6">
                    <a href="?"
                        class="px-4 py-1 rounded-full font-semibold <?php echo isActiveCat('', $active_category); ?>">
                        Tümü
                    </a>
                    ...
                    <?php if ($timeline_items):
                        foreach ($timeline_items as $item): ?>
                            <div class="relative flex">
                                <!-- Year Circle -->
                                <div
                                    class="absolute left-16 -translate-x-1/2 w-10 h-10 rounded-full bg-white border-4 border-gray-200 flex items-center justify-center z-10">
                                    <span
                                        class="text-xs font-bold"><?php echo date('Y', strtotime($item['new_date'])); ?></span>
                                </div>

                                <!-- Event Content -->
                                <div
                                    class="ml-24 bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 w-full">
                                    <div class="flex justify-between items-start mb-3">
                                        <h3 class="text-lg font-bold text-[#022d5a]">
                                    ...
                                    <p class="text-sm text-gray-600 mb-3 line-clamp-3">
                                        <?php echo strip_tags($item['content']); ?></p>

                                    <div class="flex justify-between items-center">
                                        <span
                                            class="inline-block px-3 py-1 bg-gray-100 text-xs font-medium rounded-full text-gray-700">
                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            <button
                                                onclick="shareContent('<?php echo $item['title']; ?>', '<?php echo $item['slug']; ?>')"
