                        ...
                        <div
                            ...
                            <a href="dosya_detay.php?id=<?php echo $dosya['id']; ?>" class="flex flex-col h-full">
                                <div class="relative h-48 w-full overflow-hidden">
                                    ...
                                    <?php endif; ?>
                                    <span
                                        class="absolute top-3 left-3 px-3 py-1 text-xs font-bold rounded bg-[#022d5a] text-white z-10">
                                ...
                                <div class="flex-1 flex flex-col p-4">
                                    ...
                                    <div class="mt-auto">
                                        <span class="text-sm text-[#f39200] font-semibold hover:underline">Devamını Oku
                                            &rarr;</span>
                                    </div>
                                </div>
                            </a>
