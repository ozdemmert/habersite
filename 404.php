        ...
        <div class="flex flex-col items-center justify-center min-h-[60vh] bg-gray-50 px-4 py-16">
            <div class="text-center">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="index.php"
                        class="px-6 py-3 bg-blue-900 hover:bg-blue-800 text-white font-medium rounded-md transition duration-300">
                        Ana Sayfaya Dön
                    </a>
                    <a href="javascript:history.back()"
                        class="px-6 py-3 border border-gray-300 hover:bg-gray-100 text-gray-700 font-medium rounded-md transition duration-300">
                        Geri Git
                    </a>
                </div>
            </div>
