        ...
        <div class="max-w-5xl mx-auto px-0 pl-4">
            ...
            <nav class="text-sm text-gray-500 mb-2" aria-label="Breadcrumb">
                <ol class="list-none p-0 inline-flex">
                    ...
                    <li class="flex items-center">
                        <span class="text-[#022d5a]">Story Maps</span>
                    </li>
                </ol>
            </nav>
                                ...
                                <div class="rounded-lg shadow-sm hover:shadow-md transition overflow-hidden flex">
                                    ...
                                    <div class="w-2/3 p-4 flex flex-col">
                                        <span class="text-xs text-[#f39200] font-medium mb-1">
                                            <?php echo date('d F Y', strtotime($featured['created_at'])); ?>
                                        </span>
                                        ...
                                        <a href="storymaps_detay.php?id=<?php echo $featured['id']; ?>"
            ...
            <!-- Sayfa Başlığı -->
            <h1 class="text-2xl font-bold mb-6 text-[#022d5a]">StoryMaps Projeleri</h1>
            ...
            <div class="flex flex-wrap gap-2 mb-6">
                ...
                <?php foreach ($categories as $cat): ?>
                    <a href="storymaps.php?cat=<?php echo $cat['id']; ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <?php if (!empty($all_storymaps)):
                    foreach ($all_storymaps as $storymap): ?>
                        <div
                            class="bg-white border rounded-lg shadow-sm hover:shadow-md transition overflow-hidden flex flex-col h-full">
                            <a href="storymaps_detay.php?id=<?php echo $storymap['id']; ?>" class="flex flex-col h-full">
                                ...
                                <div class="flex-1 flex flex-col p-4">
                                    ...
                                    <h3 class="font-semibold text-base mb-2 line-clamp-2 text-[#022d5a]">
                                        <?php echo htmlspecialchars($storymap['title']); ?>
                                    </h3>
                                    <p class="text-sm text-gray-600 mb-3 line-clamp-3">
